    ...
    <div className='px-4 py-8 bg-primaryLight'>
      <div className='flex flex-col items-center justify-center'>
        ...
        <p className='text-gray-600 mb-6 w-full md:w-[1020px] text-center'>
          Discover the ease of finding your perfect space with Homi. Whether you're searching for a cozy apartment or
          the ideal roommate, our platform connects you with trusted listings, tailored matches, and seamless
          communication—all in one place. Your next home is just a few clicks away!
        </p>
        <button className='bg-buttonRed text-white rounded-full px-6 py-2 mb-8'>Browse Now</button>
      </div>
