          ...
          <div className='space-y-4'>
            ...
            <div className='flex justify-start'>
              <div className='bg-black p-4 rounded-tl-3xl rounded-tr-3xl rounded-br-3xl shadow-md max-w-[60%]'>
                <p className='text-white text-lg'>Roommate Matching: Find roommates who share your vibe.</p>
              </div>
            </div>

            <div className='flex justify-end'>
              <div className='bg-primaryBlue p-4 rounded-tl-3xl rounded-tr-3xl rounded-bl-3xl shadow-md max-w-[60%]'>
                <p className='text-white text-lg'>Online Lease Signing: Secure, paperless agreements you can trust.</p>
              </div>
            </div>
          </div>
        </div>
