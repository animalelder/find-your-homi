  ...
  return (
    <div className='flex flex-col lg:flex-row min-h-screen'>
      ...
      <div className='hidden lg:block w-1/2 relative'>
        <img src={createProfile_bg} alt='Create Profile Background' className='w-full h-full object-cover' />
          ...
          <form className='w-full max-w-md bg-white rounded-lg p-6' onSubmit={handleSubmit}>
            ...
            <p className='mb-6 text-center'>
              {mode === 'create' ? (
                <>
                  Already a member?{' '}
                  <span className='text-red-500 font-medium cursor-pointer' onClick={() => setMode('sign-in')}>
                    Sign in
                  </span>
                </>
              ) : (
